  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Celebra los 50 años del Grupo Scout Apícula con nuestro juego interactivo con Realidad Aumentada."
        />

        <meta property="og:title" content="Grupo Scout Apícula - 50 Años de Aventuras" />
        <meta
          property="og:description"
          content="Juego interactivo scout con realidad aumentada y objetos impresos en 3D."
        />
